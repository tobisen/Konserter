...
test.describe('Navigation', () => {
  ...
  test('merch page opens and reloads', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { name: 'The Backstage Tote' })).toBeVisible()
    await expect(page.getByRole('heading', { name: 'The Monogram Tee' })).toBeVisible()
    await expect(page.getByRole('heading', { name: 'The Monogram Cap' })).toBeVisible()
    await expect(page.getByRole('heading', { name: 'The Venue Cap' })).toBeVisible()
    await expect(page.getByRole('heading', { name: 'The Gig Cap' })).toBeVisible()
    ...
    await expect(page.getByAltText('The Headliner Tee, svart t-shirt med Soundchecks exklusiva SC-monogram på bröstet')).toHaveAttribute('src', '/hendrix1.avif')
    await expect(page.getByAltText('The Headliner Tee med Headliner-motiv på ryggen')).toHaveAttribute('src', '/hendrix2.avif')
    await expect(page.getByAltText('The Backstage Tote, tote bag med Soundcheck-monogram på framsidan')).toHaveAttribute('src', '/images/tote1.avif')
    await expect(page.getByAltText('The Backstage Tote med konsertinspirerat motiv på baksidan')).toHaveAttribute('src', '/images/tote2.avif')
    ...
    await expect(page.getByAltText('The Monogram Cap, svart keps med Soundchecks exklusiva SC-monogram')).toHaveAttribute('src', '/images/monogramcap.avif')
    ...
    await expect(page.getByAltText('The Gig Cap, svart truckerkeps med Soundcheck-motiv')).toHaveAttribute('src', '/images/trucker1.png')
    await expect(page.getByAltText('The Gig Cap med baksida och detaljvy')).toHaveAttribute('src', '/images/trucker2.png')
    ...
    const headlinerCards = page.locator('.merch-card').filter({ hasText: 'The Headliner Tee' })
    const toteCard = page.locator('.merch-card').filter({ hasText: 'The Backstage Tote' })
    const monogramCard = page.locator('.merch-card').filter({ hasText: 'The Monogram Tee' })
    const monogramCapCard = page.locator('.merch-card').filter({ hasText: 'The Monogram Cap' })
    const capCard = page.locator('.merch-card').filter({ hasText: 'The Venue Cap' })
    const gigCapCard = page.locator('.merch-card').filter({ hasText: 'The Gig Cap' })
    ...
    await expect(headlinerCards).toHaveCount(2)
    await expect(headlinerCards.nth(0).getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('href', 'https://soundcheck-shop.fourthwall.com/en-sek/products/the-headliner-tee')
    await expect(headlinerCards.nth(0).getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('target', '_blank')
    await expect(headlinerCards.nth(0).getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('rel', 'noopener noreferrer')
    await expect(headlinerCards.nth(1).getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('href', 'https://soundcheck-shop.fourthwall.com/products/the-headliner-tee-2')
    await expect(headlinerCards.nth(1).getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('target', '_blank')
    await expect(headlinerCards.nth(1).getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('rel', 'noopener noreferrer')
    ...
    await expect(toteCard.getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('href', 'https://soundcheck-shop.fourthwall.com/products/the-backstage-tote')
    await expect(toteCard.getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('target', '_blank')
    await expect(toteCard.getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('rel', 'noopener noreferrer')
    ...
    await expect(monogramCapCard.getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('href', 'https://soundcheck-shop.fourthwall.com/products/the-monogram-cap')
    await expect(monogramCapCard.getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('target', '_blank')
    await expect(monogramCapCard.getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('rel', 'noopener noreferrer')
    ...
    await expect(gigCapCard.getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('href', 'https://soundcheck-shop.fourthwall.com/products/the-venue-cap-2')
    await expect(gigCapCard.getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('target', '_blank')
    await expect(gigCapCard.getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('rel', 'noopener noreferrer')
  ...
  test('merch page copy is translated to English', async ({ page }) => {
    ...
    await expect(page.getByText("A premium t-shirt with Soundcheck's exclusive SC monogram on the chest and the powerful Headliner motif on the back.")).toBeVisible()
    await expect(page.getByText("A clean tote bag with Soundcheck's exclusive SC monogram on the front and a concert-inspired motif on the back.")).toBeVisible()
    await expect(page.getByText("Minimalist black cap with Soundcheck's exclusive SC monogram in off-white and signature orange.")).toBeVisible()
