...
test.describe('Navigation', () => {
  ...
  test('merch page opens and reloads', async ({ page }) => {
    ...
    await expect(tshirtCard.getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('href', 'TODO_FOURTHWALL_GIG_TEE_URL')
    ...
    await expect(headlinerCard.getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('href', 'TODO_FOURTHWALL_HEADLINER_TEE_URL')
    ...
    await expect(hoodieCard.getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('href', 'TODO_FOURTHWALL_GIG_HOODIE_URL')
    ...
    await expect(capCard.getByRole('link', { name: /^Köp på Fourthwall$/ })).toHaveAttribute('href', 'TODO_FOURTHWALL_VENUE_CAP_URL')
